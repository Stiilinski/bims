                ...
                <div class="modal-content">
                  ...
                  <form method="POST" action="{{ route('regValidation.saveBrgyClearance')}}" class="brgyClearance" id="brgy_clearanceMult">
                    ...
                    <div class="modal-body">
                      <div class="row g-3">
                        <div class="col-md-6">
                          <label for="tcode1" class="form-label">Transaction Code <b>(Don't Forget To Copy This Code)</b></label>
                  ...
                  <div class="modal-body">
                    <form method="POST" action="{{ route('regValidation.saveBusinessClearance')}}" class="brgyClearance" id="brgy_clearance">
                      @csrf 
                        <div class="row g-3">
                          <div class="col-md-6">
                              <label for="tcode2" class="form-label">Transaction Code <b>(Don't Forget To Copy This Code)</b></label>
                  ...
                  <div class="modal-body">
                    <form method="POST" action="{{ route('regValidation.saveComplaints')}}" class="complaint" id="complaint">
                      @csrf
                        <div class="row g-3">
                          <div class="col-md-6">
                            <label for="tcode4" class="form-label">Transaction Code <b>(Don't Forget To Copy This Code)</b></label>
                ...
                <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="POST" action="{{ route('regValidation.saveCertificate')}}" class="certificate" id="certificate">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="tcode3" class="form-label">Transaction Code <b>(Don't Forget To Copy This Code)</b></label>
