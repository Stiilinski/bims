                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                @if($complaints->blotter_status === 'processed')
                                                    <button type="button" class="dropdown-item" onclick="updateBclStatus({{ $complaints->blotter_id }}, 'ready to pick up')">Pickup-Ready</button>
                                                @elseif($complaints->blotter_status !== 'ready to pick up' && $complaints->blotter_status !== 'rejected' && $complaints->blotter_status !== 'cancelled')
                                                    ...
                                                    <button type="button" class="dropdown-item" onclick="updateBclStatus({{ $complaints->blotter_id }}, 'Archived')">Archive</button>
                                                @elseif($complaints->blotter_status == 'ready to pick up')
                                                    <button type="button" class="dropdown-item" onclick="sendEmail('{{ $complaints->res_email }}', '{{ $complaints->res_fname }}', '{{ $complaints->res_lname }}')">Send</button>
                                                    <button type="button" class="dropdown-item" onclick="updateBclStatus({{ $complaints->blotter_id }}, 'Archived')">Archive</button>
                                                @endif
