        ...
        <div class="container">
            ...
            <div class="mainContentCon">                
                <div class="innerContent" id="certificatePrint">
                    ...
                    <div class="residentProf"><h2 class="residentRes">BARANGAY CERTIFICATION</h2></div>
                    <div class="residentProf1"><h2 class="residentRes1">(First Time Job Seekers Assistance Act - RA 11261)</h2></div>
                    <div class="contentsContainer">
                        <div class="rightsContainer">

                            <div class="bodyLetter">
                                <p class="paragraph1">This is to certify that <b>{{ $certificate->res_fname }} {{ $certificate->res_mname }} {{ $certificate->res_lname }}</b> a resident
                                of purok <span>{{ $certificate->res_purok }}, Sitio {{ $certificate->res_sitio }},</span> for one (1) year qualified availee of <b>RA 11261</b> of <b> Time Job Seekers Act of 2019</b>.</p>

                                <p class="paragraph2">I further certify that the holder/bearer was informed of his/her rights, including the 
                                    duties and responsibilities accorded by RA 11261 through Oath of Undertaking he/she has signed and executed
                                    in the presence of our Barangay official.
                                </p>

                                <p class="paragraph3">Signed this <b>{{ \Carbon\Carbon::parse($certificate->tr_date)->format('dS \d\a\y \o\f F, Y') }}</b> in the Municipality 
                                    of Minglanilla at Barangay Poblacion Ward II Minglanilla, Cebu.</p>

                                <p class="paragraph4"> This certification is valid only (one year of issuance)
                                </p>
                            </div>

                            <div class="footerLetter">
                                <h5 class="capitan"><b>HON. JHONNY FLOYD R. CASTANARES</b></h5>
                                <h6 class="capitan1">Barangay Captain</h6>
                            </div>
                            ...
                            <div class="footerLetter">
                                <h5 class="dateFoot"><b>Gracebell M. Flores</b></h5>
                                <h6 class="capitan1">Barangay Secretary</h6>
                            </div>
                        </div>
                    </div>
