        ...
        <div class="container">
            ...
            <div class="mainContentCon">                
                <div class="innerContent" id="certificatePrint">
                    ...
                    <div class="residentProf"><h2 class="residentRes">CERTIFICATE OF GOOD MORAL CHARACTER</h2></div>
                    <div class="contentsContainer">
                        <div class="rightsContainer">
                            ...
                            <div class="bodyLetter">
                                ...
                                of purok <span>{{ $certificate->res_purok }}, Sitio {{ $certificate->res_sitio }},</span> Barangay Poblacion Ward II, Minglanilla, Cebu, is personally known to me to be a 
                                person of good moral character and has no derogatory record.</p>

                                <p class="paragraph2">That he has not been accused of any crime nor has any criminal recod and he is not a member of any subversive organization.
                                </p>
                                ...
                                <p class="paragraph4">Issued this <b>{{ \Carbon\Carbon::parse($certificate->cert_dateIssued)->format('dS \d\a\y \o\f F, Y') }}</b> in the Municipality 
                                    of Minglanilla at Barangay Poblacion Ward II Minglanilla, Cebu, Philippnes.</p>
                            </div>
                            ...
                            <div class="footerLetter">
                                <span class="dateFoot">Not Valid Without Seal</span>
                            </div>
                        </div>
                    </div>
